...
class shoppingshirt extends StatefulWidget {
  const shoppingshirt({Key? key}) : super(key: key);

  @override
  State<shoppingshirt> createState() => _shoppingshirtState();
}

class _shoppingshirtState extends State<shoppingshirt> {
  @override
...
//     child: Row(
//     children:[
//       Image.network("https://firebasestorage.googleapis.com/v0/b/project-90bb1.appspot.com/o/s3.png?alt=media&token=befde63e-3fb6-4bb3-bb33-3b5bcb846696",
//       width: 120,
//       height: 120,
//       ),
//       Text('    red off top',style: TextStyle(fontSize: 25),),
//     ],
//     ),
//     onPressed: (){
//       Navigator.pushNamed(context, '/item2');
